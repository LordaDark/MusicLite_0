...
var videoIdSchema = zod_1.z.object({
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        id: input.videoId,
                        title: "Song Title for ".concat(input.videoId),
                        artist: "Artist for ".concat(input.videoId),
                        album: "Album for ".concat(input.videoId),
                        thumbnail: "https://picsum.photos/seed/".concat(input.videoId, "/300/300"),
            ...
            case 2:
                error_1 = _c.sent();
                console.error("Error getting video info:", error_1);
